...
_CATALOG: dict[str, dict[str, str]] = {
    "en": {
        ...
        "wizard.remote_lead": "Step 2 of 2 — point the app at an OpenAI-compatible endpoint and paste your API key. You can change any of this later in Settings → Remote API.",
        ...
        "settings.file_format_help": "FLAC is lossless and about half the size of WAV. Use WAV only if you need raw uncompressed audio.",
    ...
    "fr": {
        ...
        "wizard.remote_lead": "Étape 2 sur 2 — indiquez à l'application un point de terminaison compatible OpenAI et collez votre clé d'API. Vous pourrez tout modifier plus tard dans Paramètres → API distante.",
        ...
        "settings.file_format_help": "FLAC est sans perte et environ deux fois plus léger que le WAV. N'utilisez le WAV que si vous avez besoin d'audio brut non compressé.",
